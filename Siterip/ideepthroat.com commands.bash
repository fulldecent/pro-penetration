#
# IDEEPTHROAT.COM WEBRIP SCRIPTS
#
...
#	OPTS="$OPTS --no-verbose"
	...
	LOGIN="--user=3271558 --password=sallys"
	#LOGIN="--user=gishii33 --password=seiji33"
	LOGIN="--user=swaldo --password=falcon"
...
function get
{
	wget $OPTIONS ideepthroat.com/members2/
}
